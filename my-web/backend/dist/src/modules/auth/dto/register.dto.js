...
__decorate([
    ...
    (0, class_validator_1.Length)(6, 30, { message: 'Mật khẩu phải từ 6 đến 30 ký tự' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[0-9]{10}$/, { message: 'Số điện thoại phải bao gồm 10 chữ số' }),
    __metadata("design:type", String)
