 ...
 * All env values are validated and typed here — no direct process.env access elsewhere.
 *
 * Related: src/app.module.ts
 * Pattern: NestJS ConfigModule with factory function
 */
